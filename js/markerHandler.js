...
AFRAME.registerComponent("markerhandler", {
  ...
  askTableNumber: function () {
    ...
    swal({
      ...
      tableNumber = parseInt(inputValue);
    });
  },
  ...
  handlePayment: function () {
    ...
    firebase
      ...
      .then(() => {
        swal({
          icon: "success",
          title: "¡De nada por el servicio :)!",
          text: "¡Esperemos volverlo a ver por aquí!",
          timer: 2500,
          buttons: false
        });
      });
  ...
  handleRatings: async function(dish){
    ...
    //obtener el resumen de la orden desde la base de dates
    var orderSummary = await this.getOrderSummary(tNumber)
    ...
    if(current_orders.length > 0){
      ...
      swal({
        icon: "warning",
        title: "Chanfles, estoy flipando!!!",
        text: "No hemos podido encontrar ningun platillo",
        timer: 2500,
        button: false
      })
    }
